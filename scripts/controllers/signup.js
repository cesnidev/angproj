...
calcomm.controller('SignUpCtrl', function($rootScope,$scope,CalcommResource,cssInjector,$window,Session,$location,CalcommConfig,CalcommLogin,upload) {
	...
	else
	{
		...
		/* START INITS*/
			...
			$scope.profile = { "waist": "32", "jacketsize": "", "chest": "42", "hips": "", "dressize": "", "waistfemale": "", "nflanguage": "", "slanguage": "", "piercings": false, "tatoos": false, "englishfuently": false, "englishacent": false, "picture1": "", "picture2": "", "picture3": "", "picture4": "", "picture5": "", "gender": "male", "height": "4'12", "weight": "1231", "eye_color": "Green", "hair_color": "Auburn", "hair_length": "Medium", "tshirt_size": "M", "pants_size": "S", "shoes_size": "5.5", "jacket_size": "40", "first_language": "German", "second_language": "Italian", "english_accent": true, "spanish_fluently": true };
...
.service('upload',function ($http, $q,CalcommConfig) 
{
	this.uploadFile = function(file, data)
	{
		...
		formData.append('token',$scope.user.token);
		formData.append('app_id',CalcommConfig.AppId);
